...
agents_p0 = {
    "DQN-WinFirst-400k": load_dqn("./checkpoints_win_first", 0),
    "DQN-400k": load_dqn("./checkpoints_double_256_500k", 0),
...
agents_p1 = {
    "DQN-WinFirst-400k": load_dqn("./checkpoints_win_first", 1),
    "DQN-400k": load_dqn("./checkpoints_double_256_500k", 1),
...
agent_names = ["DQN-WinFirst-400k", "DQN-400k", "DQN-100k", "MCTS-50"]
